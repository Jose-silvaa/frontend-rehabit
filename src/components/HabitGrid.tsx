...
const habits = [
  { id: 1, name: "Morning Meditation", streak: 5, days: [0, 1, 2, 3, 4, 5, 6], habitLoop : {  cue: "Waking ", desire: "Feeling more hydrated and refreshed", routine: "Doing 5 minutes of stretching", reward: "Feeling awake and ready to start the day"} },
  { id: 2, name: "Read 30 minutes", streak: 3, days: [1, 2, 3, 4, 5] },
  { id: 3, name: "Exercise", streak: 2, days: [1, 3, 5] },
  { id: 4, name: "Learn a new word", streak: 7, days: [0, 1, 2, 3, 4, 5, 6] },
  { id: 5, name: "Drink 8 glasses of water", streak: 4, days: [1, 2, 3, 4, 5] },
]
              ...
              >
                <div className="flex justify-between items-center mb-2 relative">
                  ...
                  <span className="text-sm text-muted-foreground px-2 py-1 bg-secondary rounded-full">
                    {arrow ? (
                      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`cursor-pointer`} onClick={() => SetArrow(!arrow)}>
                ...
                {arrow && (
                      ...
                      <ul className="mt-2 ">
                        <li className="pb-2">🛑 Cue     : {habit.habitLoop?.cue}</li>
                        <li className="pb-2">🔥 Craving  : {habit.habitLoop?.desire}</li>
                        <li className="pb-2">🏃 Routine : {habit.habitLoop?.routine}</li>
                        <li className="pb-2">🎉 Reward  : {habit.habitLoop?.reward}</li>
                      </ul>
                    </div>
                )}
            </section>
